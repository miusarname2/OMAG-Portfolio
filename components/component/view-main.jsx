        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="group flex flex-col bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100 dark:border-gray-700">
            <div className="w-full aspect-[4/3] overflow-hidden bg-gray-100 dark:bg-gray-900 relative">
              <a href="http://urlshorten.projects.omag.cloud" target="_blank" rel="noopener noreferrer">
                <img alt="Url Shorten" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" src="/url-short.svg" />
              </a>
            </div>
            <div className="p-6 flex flex-col flex-1">
              <h3 className="text-xl font-bold mb-3">Url Shorten</h3>
              <div className="flex flex-wrap gap-2 mb-4">
                <span className="bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-2.5 py-1 rounded-md text-xs font-semibold">React</span>
                <span className="bg-green-50 dark:bg-green-900/30 text-green-600 dark:text-green-400 px-2.5 py-1 rounded-md text-xs font-semibold">Nodejs</span>
                <span className="bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 px-2.5 py-1 rounded-md text-xs font-semibold">MongoDB</span>
                <span className="bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-2.5 py-1 rounded-md text-xs font-semibold">TypeScript</span>
              </div>
              <p className="text-gray-600 dark:text-gray-400 text-sm mb-6 flex-1">{t("url_shorten_desc")}</p>
              <div className="flex items-center justify-between mt-auto">
                <a href="http://github.com/miusarname2/UrlShorten" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-sm font-medium text-gray-900 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                  <GithubIcon className="w-4 h-4 mr-2" /> {t("code")}
                </a>
                <span className="bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-400 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">{t("status_finished")}</span>
              </div>
            </div>
          </div>

          {/* Project 2: Client Administrator */}
          <div className="group flex flex-col bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100 dark:border-gray-700">
            <div className="w-full aspect-[4/3] overflow-hidden bg-gray-100 dark:bg-gray-900 relative">
              <img alt="Client Administrator" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" src="/clientsPanel.svg" />
            </div>
            <div className="p-6 flex flex-col flex-1">
              <h3 className="text-xl font-bold mb-3">Client Administrator</h3>
              <div className="flex flex-wrap gap-2 mb-4">
              ...
              <div className="flex items-center justify-between mt-auto">
                <a href="http://github.com/miusarname2/laravel-test-CRUD" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-sm font-medium text-gray-900 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                  <GithubIcon className="w-4 h-4 mr-2" /> {t("code")}
                </a>
                <span className="bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-400 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">{t("status_finished")}</span>
              </div>
          ...
          <div className="group flex flex-col bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100 dark:border-gray-700">
            ...
            <div className="p-6 flex flex-col flex-1">
              <h3 className="text-xl font-bold mb-3">Viaje por Colombia API</h3>
              <div className="flex flex-wrap gap-2 mb-4">
                <span className="bg-green-50 dark:bg-green-900/30 text-green-600 dark:text-green-400 px-2.5 py-1 rounded-md text-xs font-semibold">Node.js</span>
                <span className="bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-2.5 py-1 rounded-md text-xs font-semibold">TypeScript</span>
                <span className="bg-teal-50 dark:bg-teal-900/30 text-teal-600 dark:text-teal-400 px-2.5 py-1 rounded-md text-xs font-semibold">Prisma</span>
                <span className="bg-orange-50 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400 px-2.5 py-1 rounded-md text-xs font-semibold">MySQL</span>
              </div>
              <p className="text-gray-600 dark:text-gray-400 text-sm mb-6 flex-1">{t("viaje_col_desc")}</p>
              <div className="flex items-center justify-between mt-auto">
                <a href="http://github.com/miusarname2/test-biintelli" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-sm font-medium text-gray-900 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                  <GithubIcon className="w-4 h-4 mr-2" /> {t("code")}
                </a>
                <span className="bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-400 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">{t("status_finished")}</span>
              </div>
          ...
          <div className="group flex flex-col bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100 dark:border-gray-700">
            ...
            <div className="p-6 flex flex-col flex-1">
              <h3 className="text-xl font-bold mb-3">Seismic Data App</h3>
              <div className="flex flex-wrap gap-2 mb-4">
                <span className="bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 px-2.5 py-1 rounded-md text-xs font-semibold">Ruby</span>
                <span className="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-2.5 py-1 rounded-md text-xs font-semibold">SQLite</span>
                <span className="bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-2.5 py-1 rounded-md text-xs font-semibold">React</span>
                <span className="bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-2.5 py-1 rounded-md text-xs font-semibold">Docker</span>
              </div>
              <p className="text-gray-600 dark:text-gray-400 text-sm mb-6 flex-1">{t("seismic_desc")}</p>
              <div className="flex items-center justify-between mt-auto">
                <a href="http://github.com/miusarname2/Ruby_TestFrogmii" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-sm font-medium text-gray-900 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                  <GithubIcon className="w-4 h-4 mr-2" /> {t("code")}
                </a>
                <span className="bg-yellow-100 dark:bg-yellow-900/40 text-yellow-700 dark:text-yellow-400 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">{t("status_adapting")}</span>
              </div>
            </div>
          </div>

          {/* Project 5: TablonTask */}
          <div className="group flex flex-col bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100 dark:border-gray-700">
            <div className="w-full aspect-[4/3] overflow-hidden bg-gray-100 dark:bg-gray-900 relative">
              <img alt="TablonTask" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" src="/placeholder.svg" />
            </div>
            <div className="p-6 flex flex-col flex-1">
              <h3 className="text-xl font-bold mb-3">TablonTask</h3>
              <div className="flex flex-wrap gap-2 mb-4">
                <span className="bg-black/5 dark:bg-white/10 text-gray-800 dark:text-gray-200 px-2.5 py-1 rounded-md text-xs font-semibold">Next.js</span>
                <span className="bg-cyan-50 dark:bg-cyan-900/30 text-cyan-600 dark:text-cyan-400 px-2.5 py-1 rounded-md text-xs font-semibold">Tailwind</span>
                <span className="bg-purple-50 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 px-2.5 py-1 rounded-md text-xs font-semibold">C# .NET</span>
                <span className="bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 px-2.5 py-1 rounded-md text-xs font-semibold">SQLServer</span>
              </div>
              <p className="text-gray-600 dark:text-gray-400 text-sm mb-6 flex-1">{t("tablontask_desc")}</p>
              <div className="flex items-center justify-between mt-auto">
                <a href="http://github.com/miusarname2/Trello-Clone" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-sm font-medium text-gray-900 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                  <GithubIcon className="w-4 h-4 mr-2" /> {t("code")}
                </a>
                <span className="bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-400 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">{t("status_in_dev")}</span>
              </div>
            </div>
          </div>

          {/* Project 6: Unnamed IDE */}
          <div className="group flex flex-col bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100 dark:border-gray-700">
            <div className="w-full aspect-[4/3] overflow-hidden bg-gray-100 dark:bg-gray-900 relative">
              <img alt="Unnamed IDE" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" src="/Warning.svg" />
            </div>
            <div className="p-6 flex flex-col flex-1">
              <h3 className="text-xl font-bold mb-3">Swift IDE (Unnamed)</h3>
              <div className="flex flex-wrap gap-2 mb-4">
                <span className="bg-yellow-50 dark:bg-yellow-900/30 text-yellow-600 dark:text-yellow-400 px-2.5 py-1 rounded-md text-xs font-semibold">Tauri</span>
                <span className="bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-2.5 py-1 rounded-md text-xs font-semibold">React</span>
                <span className="bg-orange-50 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400 px-2.5 py-1 rounded-md text-xs font-semibold">Rust</span>
              </div>
              <p className="text-gray-600 dark:text-gray-400 text-sm mb-6 flex-1">{t("swift_ide_desc")}</p>
              <div className="flex items-center justify-between mt-auto">
                <span className="inline-flex items-center text-sm font-medium text-gray-400">
                  <GithubIcon className="w-4 h-4 mr-2" /> {t("private")}
                </span>
                <span className="bg-orange-100 dark:bg-orange-900/40 text-orange-700 dark:text-orange-400 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">{t("status_paused")}</span>
              </div>
            </div>
          </div>
          ...
          <div className="group flex flex-col bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100 dark:border-gray-700">
            <div className="w-full aspect-[4/3] overflow-hidden bg-gray-100 dark:bg-gray-900 relative">
              <img alt="Serviflow Platform" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" src="/placeholder.svg" />
            </div>
            <div className="p-6 flex flex-col flex-1">
              <h3 className="text-xl font-bold mb-3">Serviflow - Maintenance</h3>
              <div className="flex flex-wrap gap-2 mb-4">
                <span className="bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-2.5 py-1 rounded-md text-xs font-semibold">React</span>
                <span className="bg-green-50 dark:bg-green-900/30 text-green-600 dark:text-green-400 px-2.5 py-1 rounded-md text-xs font-semibold">Node.js</span>
                <span className="bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 px-2.5 py-1 rounded-md text-xs font-semibold">PostgreSQL</span>
              </div>
              <p className="text-gray-600 dark:text-gray-400 text-sm mb-6 flex-1">{t("serviflow_desc")}</p>
              <div className="flex items-center justify-between mt-auto">
                <a href="https://github.com/CloudPulses/serviflow-mantenimiento" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-sm font-medium text-gray-900 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                  <GithubIcon className="w-4 h-4 mr-2" /> {t("code")}
                </a>
                <span className="bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-400 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">{t("status_beta")}</span>
              </div>
            </div>
          </div>
          ...
          <div className="group flex flex-col bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100 dark:border-gray-700">
            <div className="w-full aspect-[4/3] overflow-hidden bg-gray-100 dark:bg-gray-900 relative">
              <img alt="GardenApp" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" src="/GardenApp.png" />
            </div>
            <div className="p-6 flex flex-col flex-1">
              <h3 className="text-xl font-bold mb-3">GardenApp - Plant Monitor</h3>
              <div className="flex flex-wrap gap-2 mb-4">
                <span className="bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-2.5 py-1 rounded-md text-xs font-semibold">React Native</span>
                <span className="bg-purple-50 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 px-2.5 py-1 rounded-md text-xs font-semibold">IoT</span>
              </div>
              <p className="text-gray-600 dark:text-gray-400 text-sm mb-6 flex-1">{t("gardenapp_desc")}</p>
              <div className="flex items-center justify-between mt-auto">
                <a href="https://github.com/miusarname2/GardenApp" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-sm font-medium text-gray-900 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                  <GithubIcon className="w-4 h-4 mr-2" /> {t("code")}
                </a>
                <span className="bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-400 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">{t("status_finished")}</span>
              </div>
          ...
          <div className="group flex flex-col bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100 dark:border-gray-700">
            ...
            <div className="p-6 flex flex-col flex-1">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                <span className="bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-2.5 py-1 rounded-md text-xs font-semibold">Python</span>
                <span className="bg-yellow-50 dark:bg-yellow-900/30 text-yellow-600 dark:text-yellow-400 px-2.5 py-1 rounded-md text-xs font-semibold">Pandas</span>
                <span className="bg-pink-50 dark:bg-pink-900/30 text-pink-600 dark:text-pink-400 px-2.5 py-1 rounded-md text-xs font-semibold">Flet</span>
              </div>
              <p className="text-gray-600 dark:text-gray-400 text-sm mb-6 flex-1">{t("dian_desc")}</p>
              <div className="flex items-center justify-between mt-auto">
                <span className="inline-flex items-center text-sm font-medium text-gray-400">
                  <GithubIcon className="w-4 h-4 mr-2" /> {t("private")}
                </span>
